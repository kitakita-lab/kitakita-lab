...
export const newsItems: NewsItem[] = [
  {
    ...
    category: 'お知らせ',
    excerpt:
      '「挑戦は、待つものではなく、育てるもの。」——KitaKita Labのブランドストーリーを新しくしました。',
    body: [
      'KitaKita Labは、ブランドストーリーを新しくしました。',
      '私たちはこれまで「ハンドメイド作家がもっと挑戦できる世界をつくる」ことを掲げて活動してきました。その想いは変わりません。ただ、活動を続けるなかで気づいたことがあります。育てたい挑戦は、ハンドメイドだけではないということです。',
      '人の一歩も、地域の企画も、企業の新しい試みも、生まれたてのアイデアも。やってきた「きた」を見過ごさず、試し、育て、かたちにして届ける——それがKitaKita Labの役割だと考え、「北海道から、新しい挑戦を育てる。」をブランドの軸に据えました。',
