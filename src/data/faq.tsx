...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      '北海道の「ちょっと進めてみる」ための場所です。何を進めるかは決まっていません。作品でも、仕事でも、アイデアでも。大きな約束はしませんが、道がちょっと豊かになるような時間・体験・出会いを用意しています。',
  },
  {
    id: 'handmade-company',
    audience: '全般',
    ...
    answer:
      'ハンドメイドやワークショップは、いま育てているものの一部です。ほかにも、AIやシステムづくり、EC、地域や企業との企画などを育てています。ばらばらに見えるかもしれませんが、すべて「ちょっと進めてみる」という同じ考えから生まれています。',
  },
  {
